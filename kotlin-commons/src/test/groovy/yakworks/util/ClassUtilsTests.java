...
class ClassUtilsTests {
	...
	void forName() throws ClassNotFoundException {
		...
		assertThat(ClassUtils.forName(String[][].class.getName(), classLoader)).isEqualTo(String[][].class);
		assertThat(ClassUtils.forName(String[][][].class.getName(), classLoader)).isEqualTo(String[][][].class);
		assertThat(ClassUtils.forName("yakworks.util.TestObject", classLoader)).isEqualTo(TestObject.class);
		assertThat(ClassUtils.forName("yakworks.util.TestObject[]", classLoader)).isEqualTo(TestObject[].class);
	...
	void forNameWithNestedType() throws ClassNotFoundException {
		assertThat(ClassUtils.forName("yakworks.util.ClassUtilsTests$NestedClass", classLoader)).isEqualTo(NestedClass.class);
		assertThat(ClassUtils.forName("yakworks.util.ClassUtilsTests.NestedClass", classLoader)).isEqualTo(NestedClass.class);
	}
	...
	void getQualifiedName() {
		...
		assertThat(className).as("Class name did not match").isEqualTo("yakworks.util.ClassUtilsTests");
	}
